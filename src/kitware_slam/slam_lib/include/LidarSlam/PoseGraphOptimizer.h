...
public:
  ...
  //! Add a constraint from a manual anchor. If useFixedPose is false, only XYZ is constrained
  //! using the top-left 3x3 of covariance. Otherwise, a full 6D pose constraint is added.
  void AddManualPoseConstraint(int lidarIdx, const Eigen::Isometry3d& pose,
