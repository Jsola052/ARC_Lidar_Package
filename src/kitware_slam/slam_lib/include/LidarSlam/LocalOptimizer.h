...
public:
  ...
  struct RegistrationError
  {
    ...
    // Estimation of the maximum orientation error (in degrees)
    ...
    // Covariance matrix encoding the estimation of the pose's errors about the 6-DoF parameters (in radians)
