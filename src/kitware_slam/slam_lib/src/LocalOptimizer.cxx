...
ceres::Solver::Summary LocalOptimizer::Solve()
{
  ...
  // Ensure the parameter block exists even if the residual list is empty.
  this->Problem->AddParameterBlock(this->PoseArray.data(), 6);
  ...
  if (this->TwoDMode)
  {
    ...
    #if ((CERES_VERSION_MAJOR == 2 && CERES_VERSION_MINOR < 1) || CERES_VERSION_MAJOR < 2)
